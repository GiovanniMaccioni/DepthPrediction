...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv5 = ConvBlockResNetLast(64, 3)
...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.conv_tr1 = ConvTranspBlockResNetFirst(64, 32, 3, output_padding=(1,1))
        self.post_conv1 = nn.ConvTranspose2d(64, 32, 3, padding=1, stride=2, output_padding=(1,1))#kernel_size = (3,4)

        self.conv_tr2 = ConvTranspBlockResNet(32, 16, 3, output_padding=(0,1))
        self.post_conv2 = nn.ConvTranspose2d(32, 16, 3, padding=1, stride=2, output_padding=(0,1))

        self.conv_tr3 = ConvTranspBlockResNet(16, 8, 3, output_padding=(1,1))
        self.post_conv3 = nn.ConvTranspose2d(16, 8, 3, padding=1, stride=2, output_padding=(1,1))

        self.conv_tr4 = ConvTranspBlockResNet(8, 4, 3)#TOCHECK The out_channels is at 1 because we have to produce an image; at this stage
        self.post_conv4 = nn.ConvTranspose2d(8, 4, 3, padding=1, stride=2)

        self.conv_tr5 = ConvTranspBlockResNetLast(4, 1, 3)#TOCHECK The out_channels is at 1 because we have to produce an image; at this stage
        self.post_conv5 = nn.ConvTranspose2d(4, 1, 7, padding=1, stride=2, output_padding=(1,1))
