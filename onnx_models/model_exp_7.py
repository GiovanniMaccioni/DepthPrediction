...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.conv2 = ConvBlock(8, 12, 3)
        self.conv3 = ConvBlock(12, 16, 3)
        self.conv4 = ConvBlock(16, 20, 3)
        self.conv5 = ConvBlock(20, 24, 3)
        self.conv6 = ConvBlock(24, 28, 3)
...
class Decoder(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv_tr1 = ConvTranspBlock(28, 24, 3)
        self.conv_tr2 = ConvTranspBlock(24, 20, 3)
        self.conv_tr3 = ConvTranspBlock(20, 16, 3)
        self.conv_tr4 = ConvTranspBlock(16, 12, 3)#TOCHECK The out_channels is at 1 because we have to produce an image; at this stage 
                                            # it can be the last frame or the next one
        self.conv_tr5 = ConvTranspBlock(12, 8, 3)
        self.conv_tr6 = ConvTranspBlock(8, 1, 3)                                        
